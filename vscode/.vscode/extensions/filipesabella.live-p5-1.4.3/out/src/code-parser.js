    ...
    try {
        ...
        types.visit(ast, {
            visitLiteral: (path) => {
                ...
                path.replace(typeBuilders.memberExpression(typeBuilders.identifier(AllVarsVariableName), typeBuilders.identifier(key)));
                return false;
            }
        });
 ...
 */
function detectCodeChanges(actual, expected) {

...
class livecodeUtils {
    static getEnvFilePath() {
        let envFilePath = vscodeUtilities_1.default.getSettingOrOtherExtSettingAsDefault("livecode", "python", "envFile");
        if (!envFilePath)
            envFilePath = "${workspaceFolder}/.env";
        return vscodeUtilities_1.default.expandPathSetting(envFilePath);
    }
    static getPythonPath() {
        let pythonPath = vscodeUtilities_1.default.getSettingOrOtherExtSettingAsDefault("livecode", "python", "pythonPath");
        if (!pythonPath)
...
exports.default = livecodeUtils;
//# sourceMappingURL=livecodeUtilities.js.map